    ...
    <Layout title={`Terms of Use`}>
      <div className="p-4 text-sm text-slate-500 xl:mx-auto xl:w-[1120px]">
        ...
        <p className="my-2">
          ...
          that oversee your use of the Site.&nbsp;BY LOGGING INTO THE SITE, YOU
          ARE BEING COMPLIANT THAT THESE TERMS and you represent that you have
          the authority and capacity to enter into these Terms.&nbsp;YOU SHOULD
          BE AT LEAST 18 YEARS OF AGE TO ACCESS THE SITE. IF YOU DISAGREE WITH
          ALL OF THE PROVISION OF THESE TERMS, DO NOT LOG INTO AND/OR USE THE
          SITE.
        </p>
        <p className="my-2">
        ...
        <p className="my-2">
          ...
          or without notice to you.&nbsp; You approved that Company will not be
        ...
        <p className="my-2">
          ...
          doing so. When you click on any of the Third-Party Links &amp; Ads,
        ...
        <p className="my-2">
          ...
          Site.&nbsp; We may suspend or terminate your rights to use the Site at
          ...
          associated with your Account from our live databases.&nbsp; Company
          ...
          these Terms are terminated, the following provisions of these Terms
          will remain in effect: Sections 2 through 2.5, Section 3 and Sections
          4 through 10.
        </p>
        ...
        <p className="my-2">
          ...
          the form of a written notification (pursuant to 17 U.S.C. § 512(c))
        ...
        <p className="my-2">
          ...
          notice.&nbsp; Any changes to these Terms will be effective upon the
          earliest of thirty (30) calendar days following our dispatch of an
          e-mail notice to you or thirty (30) calendar days following our
        ...
        <p className="my-2">
          ...
          basis of the claim or dispute, and the requested relief.&nbsp; A
          ...
          either party may begin an arbitration proceeding.&nbsp; The amount of
        ...
        <p className="my-2">
          ...
          parties shall agree to select an alternative ADR Provider.&nbsp; The
          ...
          The AAA Consumer Arbitration Rules governing the arbitration are
          ...
          Thousand U.S. Dollars (US $10,000.00) or more, the right to a hearing
          will be determined by the Arbitration Rules.&nbsp; Any hearing will be
          held in a location within 100 miles of your residence, unless you
          ...
          greater than the last settlement offer that the Company made to you
        ...
        <p className="my-2">
          ...
          initiating the arbitration.&nbsp; The arbitration shall not involve
        ...
        <p className="my-2">
          ...
          conclusions on which the award is based.&nbsp; The arbitrator has the
        ...
        <p className="my-2">
          ...
          the party against whom the claim is asserted.&nbsp; Such waiver shall
        ...
        <p className="my-2">
          ...
          a waiver of any other rights or obligations under this Arbitration
          Agreement.
        </p>
        <p className="my-2">
        ...
        <p className="my-2">
          ...
          Terms.&nbsp; The terms and conditions set forth in these Terms shall
