export default function GetIcon({ name, state, className }) {
  let tmp = name.toLowerCase();
  switch (tmp) {
    case `home`:
      return IconHome(state);
    case `history`:
      return IconHistory(state);
    case `category`:
      return IconCategory(state);
    case `information`:
      return IconInformation(state);
    case `game`:
      return IconGame(className);
    case `new`:
      return IconNew(className);
    case `arrowright`:
      return IconArrowRight(className);
    case `fire`:
    case `hot`:
      return IconFire(className);
    case `action`:
